                    ...
                    <div className="mx-auto py-5 px-4">
                        ...
                        <div className="bg-blue-50 rounded-lg w-full p-8 mt-12 shadow-lg border-2">
                            ...
                            <div className="flex items-center">
                                ...
                                <button type="button" aria-label="Usage Help">
                                    <InformationCircleIcon className="w-5 h-5" />
                                </button>
                            </div>
                            <input placeholder="Input first-order statement..." className="w-full rounded-lg my-2 p-2 border-2" />
                            <input placeholder="Input first-order statement..." className="w-full rounded-lg my-2 p-2 border-2" />
                            <button type="button" className="border-2 border-blue-300 text-blue-500 hover:bg-blue-100 hover:border-blue-500 text-bold font-medium py-2 px-4 my-2 rounded transition-colors duration-300"> Add Statement </button>
                            <p>  </p>
                            <p>  </p>
                            <p>  </p>
